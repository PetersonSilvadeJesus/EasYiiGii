...
$this->title = <?= $generator->generateString('Update {modelClass}: ', ['modelClass' => Inflector::camel2words(StringHelper::basename($generator->modelClass))]) ?> . ' ' . $model->{$model::representingColumn()} ?>;
...
$this->params['breadcrumbs'][] = ['label' => $model->{$model::representingColumn()} ?>, 'url' => ['view', <?= $urlParams ?>]];
